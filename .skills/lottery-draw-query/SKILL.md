...
| 接口 | 方法 | Endpoint |
|------|------|----------|
| 彩票开奖 | POST | `https://app-bmqdxv66ipkx-api-baBw2m51JXz9-gateway.appmiaoda.com/caipiao/query` |
| 历史开奖信息 | POST | `https://app-bmqdxv66ipkx-api-qYGW2z745vzY-gateway.appmiaoda.com/caipiao/history` |
| 查询是否中奖 | POST | `https://app-bmqdxv66ipkx-api-2Y00V8pRRoxY-gateway.appmiaoda.com/caipiao/winning` |
| 彩票分类 | POST | `https://app-bmqdxv66ipkx-api-BYdwQyx58E6L-gateway.appmiaoda.com/caipiao/class` |
