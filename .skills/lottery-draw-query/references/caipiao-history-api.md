...
| Endpoint | `POST https://app-bmqdxv66ipkx-api-qYGW2z745vzY-gateway.appmiaoda.com/caipiao/history` |
| Auth | `platform_managed`，`X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| Content-Type | `application/json` |
| Third-party Domain | `app-bmqdxv66ipkx-api-qYGW2z745vzY-gateway.appmiaoda.com` |
...
async function queryCaipiaoHistory(
  ...
  const url =
    `https://app-bmqdxv66ipkx-api-qYGW2z745vzY-gateway.appmiaoda.com/caipiao/history?${params.toString()}`;
